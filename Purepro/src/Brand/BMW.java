...
public class BMW extends WindowAdapter implements ActionListener {

	private JFrame frame;
	private int index;
	private JTextArea Area = new JTextArea();
	
	private String[] images = { "image/BMWIX.png", "image/BMWI3.png", "image/BMWI4.png",
			"image/BMWIX3.png"};
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\BMW로고.jpg"));
	...
	public ArrayList<CarDTO> BMWF() {
		...
		try {
			...
			sql.append(
					"select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'BMW' ");
