...
public class Tesla extends WindowAdapter implements ActionListener {
	...
	private String[] images = { "image/모델3.png", "image/모델y.png", "image/모델x.png","image/모델s.png"
			};
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\테슬라로고.png"));
	...
	public ArrayList<CarDTO> TeslaF() {
		...
		try {
			...
			sql.append(
					"select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'Tesla' ");
