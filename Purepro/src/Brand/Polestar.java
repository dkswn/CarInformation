...
public class Polestar extends WindowAdapter implements ActionListener {
	private JFrame frame;
	private int index;
	private JTextArea Area = new JTextArea();
	private String[] images = { "image/polestar.png", "image/polestar3.png" };
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\폴스타로고.png"));
	...
	public ArrayList<CarDTO> polestarF() {
		...
		try {
			...
			sql.append(
					"select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'polestar' ");
