...
public class Chevrolet extends WindowAdapter implements ActionListener  {
	private JFrame frame;
	private int index;
	private JTextArea Area = new JTextArea();

	private String[] images = { "image/EUV.png", "image/볼트EV.png",
			};
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\쉐보레로고.jpg"));
	...
	public ArrayList<CarDTO> ChevroletF() {
		...
		try {
			...
			sql.append("select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'Chevrolet' ");
