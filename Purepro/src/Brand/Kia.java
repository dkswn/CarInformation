...
public class Kia extends WindowAdapter implements ActionListener  {
	private JFrame frame;
	private int index;
	private JTextArea Area = new JTextArea();
	private String[] images = { "image/봉고3.png", "image/니로.png", "image/EV6.png",
			"image/니로플러스.png"};
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\기아로고.png"));
	...
	public ArrayList<CarDTO> KiaF() {
		...
		try {
			...
			sql.append(
					"select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'KIA' ");
