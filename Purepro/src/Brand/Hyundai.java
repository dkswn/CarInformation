...
public class Hyundai extends WindowAdapter implements ActionListener {
	private JFrame frame;
	private int index;
	private JTextArea Area = new JTextArea();
	private String[] images = { "image/porter.png", "image/아이오닉5.png", "image/아이오닉6.png", "image/넥쏘.png" };
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\현대로고.png"));
	...
	public ArrayList<CarDTO> HyundaiF() {
		...
		try {
			...
			sql.append(
					"select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'Hyundai' ");
