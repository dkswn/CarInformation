...
public class Genesis  extends WindowAdapter implements ActionListener {
	...
	private String[] images = { "image/G80.png", "image/GV70.png", "image/GV60.png"
			};
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\제네시스로고.png"));
	...
	public ArrayList<CarDTO> GenesisF() {
		...
		try {
			...
			sql.append("select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'Genesis' ");
