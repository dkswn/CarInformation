...
public class Peugeot extends WindowAdapter implements ActionListener {
	private JFrame frame;
	private int index;
	private JTextArea Area = new JTextArea();
	private String[] images = { "image/2008.png", "image/208.png"};
...
// frame 안에 이미지추가
		...
		JButton logo = new JButton(new ImageIcon("image\\푸조마크.png"));
	...
	public ArrayList<CarDTO> PeugeotF() {
		...
		try {
			...
			sql.append(
					"select NO, BRAND, MODEL, PRICE, TYPE, BCAPACITY, POWER, MILEAGE, MAXDISTANCE from CAR where Brand = 'Peugeot' ");
